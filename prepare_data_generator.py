    ...
    if landmark_type == 'muct_clmtools':
        ...
        with open(annotation_path) as fi:
            for line in fi:
                ...
                face_landmark = FaceLandmark(landmarks, landmark_type, None, image.shape)
...
def augment_data(face_landmarks,
    ...
    for fl_ind in range(size, 0, -1):
        ...
        for augment_i in range(augment_size):
            ...
            if not only_fliplr:
                output_face_landmarks.append(FaceLandmark(landmarks, fl.landmark_type, None, image.shape))
            if fliplr:
                ...
                output_face_landmarks.append(FaceLandmark(landmarks_flipped, fl.landmark_type, None, image_flipped.shape))
...
for key in face_landmarks_dict.keys():
    #TODO filter out landmarks that cannot be found
...
# image_face_landmark_data_generator = ImageFaceLandmarkDataGenerator()
# for x,y in image_face_landmark_data_generator.flow(face_landmarks, (32, 32), 32):
#     print(x, y)
...
#                                             'face', face_width, 0.2,
#                                             'left_eye', 0.3, 0.3,
#                                             'left_eye', (object_width, object_width))
...
#                                              'face', face_width, 0.2,
#                                              'right_eye', 0.3, 0.3,
#                                              'right_eye', (object_width, object_width),
#                                              True)
